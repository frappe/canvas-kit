...
import type { CanvasProps, StyleProperty, StyleValue } from "../types";
import { collapseBoxShorthand, expandBoxShorthand } from "../utils/boxShorthand";
import { startDrag } from "../utils/cursor";
import { getNumberFromPx } from "../utils/numberUnit";
...
export function useSpacingHandler(getTargetBlock: () => CanvasBlock, getBreakpoint: () => string) {
